...
public class RdsCdkStack extends Stack {
    public RdsCdkStack(final Construct scope, final String id, Vpc vpc) {
        this(scope, id, null, vpc);
    }

    public RdsCdkStack(final Construct scope, final String id, final StackProps props, Vpc vpc) {
        super(scope, id, props);

        CfnParameter databasePasword = CfnParameter.Builder.create(this, "databasePassword")
                .type("String")
        ...
        DatabaseInstance databaseInstance = DatabaseInstance.Builder
                ...
                .credentials(Credentials.fromUsername("admin", CredentialsFromUsernameOptions.builder()
                        .password(SecretValue.plainText(databasePasword.getValueAsString()))
                        .build()))
        ...
        CfnOutput.Builder.create(this,"rds-password")
                ...
                .value(databasePasword.getValueAsString())
                .build();
    }
}
